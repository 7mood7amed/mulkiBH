    ...
    <div style={{ direction: isRTL ? 'rtl' : 'ltr', maxWidth: '800px', margin: '0 auto', padding: 'clamp(16px, 4vw, 32px) clamp(12px, 3vw, 24px)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
          ...
          {order.phone && (
            <div style={{ background: '#f8f9fa', padding: '14px', borderRadius: '8px' }}>
              ...
              <a href={`tel:${order.phone}`} style={{ margin: 0, color: '#1a3c5e', fontWeight: '500', textDecoration: 'none' }}>📞 {order.phone}</a>
            </div>
          )}
          <div style={{ background: '#f8f9fa', padding: '14px', borderRadius: '8px' }}>
      ...
      {showForm && (
        <div style={{ background: 'white', borderRadius: '12px', padding: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.07)', marginBottom: '24px' }}>
          <h3 style={{ color: '#1a3c5e', marginBottom: '16px' }}>💬 {isRTL ? 'إرسال رد' : 'Send Response'}</h3>
      ...
      <div style={{ background: 'white', borderRadius: '12px', padding: '24px', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
        <h3 style={{ color: '#1a3c5e', marginBottom: '20px' }}>
            ...
            {order.responses.map((r, i) => (
              <div key={i} style={{ background: '#f8f9fa', borderRadius: '10px', padding: '18px', borderLeft: isRTL ? 'none' : '4px solid #1a3c5e', borderRight: isRTL ? '4px solid #1a3c5e' : 'none' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px', flexWrap: 'wrap', gap: '8px' }}>
                  <div>
                    <p style={{ margin: '0 0 2px', fontWeight: '700', color: '#1a3c5e' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                  {r.responder_phone && (
                    <a href={`tel:${r.responder_phone}`} style={{ color: '#1a3c5e', textDecoration: 'none', fontSize: '14px', fontWeight: '500' }}>
                      📞 {r.responder_phone}
                    </a>
                  )}
